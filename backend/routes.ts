...
import { get_notes, get_global_notes, get_complaints, submit_complaint, delete_complaint, get_global_complaints, submit_global_complaint } from './controllers/student'
...
router.post("/student/global_complaints/", isComplaint, isAuth, isStudent, get_global_complaints)
router.post("/student/complaints/", isComplaint, isAuth, isStudent, submit_complaint)
router.post("/student/global_complaints/", isComplaint, isAuth, isStudent, submit_global_complaint)
